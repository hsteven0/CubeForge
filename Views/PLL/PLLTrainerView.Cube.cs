...
namespace CubeForge.Views
{
    public partial class PLLTrainerView : UserControl
    {
        ...
        private void ApplySelectedMode()
        {
            ...
            CubeColor topColor = CubeControlPanel.TopColor;
            CubeRenderMode renderMode = IsPllTrainerDisplayMode() ? CubeRenderMode.PllTrainer : CubeRenderMode.FullColor;

            cube.SetRenderMode(renderMode, topColor);
            CubeControlPanel.FrontColorEnabled = true;
        }

        private bool IsPllTrainerDisplayMode()
        {
            return CubeControlPanel != null && CubeControlPanel.DisplayMode == "PLL Trainer";
        }
